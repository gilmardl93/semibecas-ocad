                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php if($row->iduser != "" && $row->observaciones != "" && $row->otorga != "" && $row->promedio != ""){ 
                                                ...
                                                <td><?php if($row->iduser != "" && $row->observaciones != "" && $row->otorga != "" && $row->promedio != ""){ echo '<span class="label label-primary">TERMINADO</span>'; }else{ echo '<span class="label label-danger">INCONCLUSO</span>'; } ?> </td>
                                                <td> {!! $row->otorga !!} </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
